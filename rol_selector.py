...
class RolSelector(ctk.CTk):
    def __init__(self):
        ...
        # Título arriba con fondo celeste y sin bordes redondeados
        self.titulo = ctk.CTkLabel(self, text="¿Cómo querés ingresar?",
                                   font=("Montserrat", 20, "bold"),
                                   text_color="#333333",
                                   fg_color="#B2EBF2",  # celeste
                                   corner_radius=0)
        self.titulo.place(relx=0.5, rely=0.1, anchor="center")

        # Botón administrador abajo a la izquierda, fondo amarillo sin redondeo
        ...
        # Botón socio abajo a la derecha, fondo amarillo sin redondeo
